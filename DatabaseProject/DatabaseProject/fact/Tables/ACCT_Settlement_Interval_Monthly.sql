CREATE TABLE [fact].[ACCT_Settlement_Interval_Monthly] (
    ...
    [IsRPSMatch]                   INT           NULL,
    CONSTRAINT [PK_ACCT_Settlement_Interval_Monthly] PRIMARY KEY CLUSTERED ([JourneyRef] ASC, [FromJourneyPointRef] ASC, [ToJourneyPointRef] ASC)
);
