CREATE TABLE [data].[ACCT_Settlement_StopException_Monthly] (
    ...
    CONSTRAINT [PK_ACCT_Settlement_StopException_Monthly] PRIMARY KEY CLUSTERED ([ExceptionId] ASC, [Version] ASC, [StopPointNumber] ASC)
);
