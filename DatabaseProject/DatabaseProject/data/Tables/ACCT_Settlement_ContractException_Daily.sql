CREATE TABLE [data].[ACCT_Settlement_ContractException_Daily] (
    ...
    CONSTRAINT [PK_ACCT_Settlement_ContractException_Daily] PRIMARY KEY CLUSTERED ([ExceptionId] ASC, [Version] ASC, [ContractCode] ASC)
);
