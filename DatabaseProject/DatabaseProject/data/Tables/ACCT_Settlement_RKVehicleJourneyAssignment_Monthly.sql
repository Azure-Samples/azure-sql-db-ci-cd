CREATE TABLE [data].[ACCT_Settlement_RKVehicleJourneyAssignment_Monthly] (
    ...
    CONSTRAINT [PK_ACCT_Settlement_RKVehicleJourneyAssignment_Monthly] PRIMARY KEY CLUSTERED ([SourceSystemEntryRef] ASC)
);
