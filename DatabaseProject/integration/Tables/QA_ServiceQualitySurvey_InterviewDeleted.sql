CREATE TABLE [integration].[QA_ServiceQualitySurvey_InterviewDeleted] (
    [Id]                     BIGINT         NOT NULL,
    ...
    CONSTRAINT [PK_QA_ServiceQualitySurvey_InterviewDeleted_1] PRIMARY KEY CLUSTERED ([Id] ASC, [SourceFileName] ASC)
);
