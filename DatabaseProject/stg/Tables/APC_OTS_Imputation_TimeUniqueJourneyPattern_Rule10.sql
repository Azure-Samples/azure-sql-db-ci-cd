CREATE TABLE [stg].[APC_OTS_Imputation_TimeUniqueJourneyPattern_Rule10] (
    [Period]               INT            NOT NULL,
    ...
    CONSTRAINT [PK_APC_OTS_Imputation_TimeUniqueJourneyPattern_Rule10] PRIMARY KEY CLUSTERED ([Period] ASC, [OperatingDayType] ASC, [JourneyPatternId] ASC, [JourneyStartTime] ASC)
);
