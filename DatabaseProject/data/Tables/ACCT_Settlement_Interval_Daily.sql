CREATE TABLE [data].[ACCT_Settlement_Interval_Daily] (
    ...
    CONSTRAINT [PK_ACCT_Settlement_Interval_Daily] PRIMARY KEY CLUSTERED ([JourneyRef] ASC, [FromStop] ASC, [ToStop] ASC)
);
