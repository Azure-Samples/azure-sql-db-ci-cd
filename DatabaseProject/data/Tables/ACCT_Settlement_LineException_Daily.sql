CREATE TABLE [data].[ACCT_Settlement_LineException_Daily] (
    ...
    CONSTRAINT [PK_ACCT_Settlement_LineException_Daily] PRIMARY KEY CLUSTERED ([ExceptionId] ASC, [Version] ASC, [LineNumber] ASC, [LineDirectionCode] ASC)
);
