CREATE TABLE [data].[APC_ATS_TimeGroupUniqueJourneyPatternPointImputed] (
    ...
    [Published]                             BIT            CONSTRAINT [DF_APC_ATS_TimeUniqueJourneyPatternPointImputed_Published] DEFAULT ((0)) NOT NULL,
    [InsertedUtc]                           DATETIME2 (0)  NOT NULL,
    [UpdatedUtc]                            DATETIME2 (0)  NOT NULL,
    CONSTRAINT [PK_APC_ATS_TimeUniqueJourneyPatternPointImputed] PRIMARY KEY CLUSTERED ([TimeGroupUniqueJourneyPatternPointRef] ASC)
);
