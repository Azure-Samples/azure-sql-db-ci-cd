CREATE TABLE [data].[RK_Trip_2019] (
    ...
    CONSTRAINT [PK_RK_Trip_2019] PRIMARY KEY CLUSTERED ([TripRef] ASC)
);


GO

CREATE COLUMNSTORE INDEX [CSIX_RK_Trip_2019]
    ON [data].[RK_Trip_2019]([TripRef], [TripDate], [TripStartTime], [TripEndTime], [TripYearWeek], [TripYearMonth], [TripDay], [TripDayType], [TripHourBand], [TripType], [TripPrice], [StartStopPointID], [EndStopPointID], [MediaTypeName], [CardTripSequenceNumber], [YoungsterCount], [ChildCount], [AdultCount], [SeniorCount], [PersonCount], [BicycleCount], [DogCount], [TotalCount]);
