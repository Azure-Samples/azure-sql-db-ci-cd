CREATE TABLE [data].[ACCT_Settlement_RKVehicleJourneyAssignment_Daily] (
    ...
    CONSTRAINT [PK_ACCT_Settlement_RKVehicleJourneyAssignment_Daily] PRIMARY KEY CLUSTERED ([SourceSystemEntryRef] ASC)
);
