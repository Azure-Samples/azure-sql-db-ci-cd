CREATE TABLE [data].[QA_ServiceQuality_ServiceLevel] (
    ...
    CONSTRAINT [PK_QA_ServiceQuality_ServiceLevel] PRIMARY KEY CLUSTERED ([SourceSystemCode] ASC, [SourceSystemEntryRef] ASC)
);
