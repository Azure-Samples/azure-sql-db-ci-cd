CREATE TABLE [data].[ACCT_Settlement_PTVehicleJourneyAssignment_Daily] (
    ...
    CONSTRAINT [PK_ACCT_Settlement_PTVehicleJourneyAssignment_Daily] PRIMARY KEY CLUSTERED ([SourceSystemEntryRef] ASC)
);
